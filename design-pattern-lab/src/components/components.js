...
var menuComponent$1 = await createAutoInstaller(import.meta.url, {
...
var listComponent$1 = await createAutoInstaller(import.meta.url, {
...
const DefaultLayout = {
  name: "DefaultLayout",
  components: {  menuComponent: menuComponent$1, listComponent: listComponent$1},
  props: {
    indexPage: {
      type: String,
...
var ratingStarComponent$1 = await createAutoInstaller(import.meta.url, {
...
const listUseStarTemp = {
  components: { ratingStarComponent: ratingStarComponent$1 },
...
const loginComponent$1 = defineComponent({
  name: "loginComponent",
  emits: ["submit", "cancel"],
  setup(_, { emit }) {
...
var loginComponent = await createAutoInstaller(import.meta.url, {
  componentFile: 'loginComponent.js',
  exportName: 'loginComponent' //- 元件的name
});
...
var coverComponent = await createAutoInstaller(import.meta.url, {
...
var modalComponent = await createAutoInstaller(import.meta.url, {
...
window.__BUNDLED_COMPONENTS__ = {
  ...
  'coverComponent.js': coverComponent$1,
  'listComponent.js': listComponent,
  'listUseStarTemp.js': listUseStarTemp,
  'loginComponent.js': loginComponent$1,
  'menuComponent.js': menuComponent,
  'modalComponent.js': modalComponent$1,
...
var index = {
  install(app) {
    ...
    app.component('coverComponent', coverComponent$1);
    app.component('listComponent', listComponent);
    app.component('listUseStarTemp', listUseStarTemp);
    app.component('loginComponent', loginComponent$1);
    app.component('menuComponent', menuComponent);
    app.component('modalComponent', modalComponent$1);
