...
// 註冊元件
const modules$1 = await Promise.all([
...
var allComponents = {
  install(app) {
    modules$1.forEach(mod => app.use(mod.default));
  }
};
...
const modules = await Promise.all([
  import('./index-DgWaAXyy.js'),
  import('./index-WQ1qvzj6.js'),
  import('./index-DMsVxjUz.js'),
  import('./index-B5cTc2mD.js'),
  import('./index-Cp-_pHJE.js'),
]);
